...
try:
    ...
    order2 = Order(customer1, coffee2, 6.0)
    order3 = Order(customer2, coffee1, 4.0)

    print(customer1.orders())  # Output: [<__main__.Order object at ...>, <__main__.Order object at ...>]
    print([order.coffee.name for order in customer1.orders()])  # Output: ['Latte', 'Espresso']

    print(customer1.coffees())  # Output: [<__main__.Coffee object at ...>, <__main__.Coffee object at ...>]
    print([coffee.name for coffee in customer1.coffees()])  # Output: ['Latte', 'Espresso']
